      ...
      <nav>
        <ul class="nav">
          ...
          @if(auth()->user()->role == 'admin')
            ...
            <li><a href="/angsuran" class=""><i class="lnr lnr-book"></i> <span>Angsuran Anggota</span></a></li>
            <li><a href="/pemasukan" class=""><i class="lnr lnr-book"></i> <span>Pemasukan Angsuran</span></a></li>
