                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="/pemasukan/{{$angsuran_masuk->id}}/update" method="post" enctype="multipart/form-data">
                                ...
                                placeholder="Nama" value="{{$angsuran_masuk->nama}}">        
                                </div>
